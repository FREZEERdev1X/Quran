...
export function App() {
  ...
  [span_0](start_span)// مراقبة الوضع الداكن لضمان استجابة الخلفية للزر الموجود في الـ Header الأصلي[span_0](end_span)
  ...
  return (
    <div className="min-h-screen transition-colors duration-300 bg-emerald-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100" dir="rtl">
      [span_1](start_span){/* إعادة الهيدر الأصلي كما طلبت[span_1](end_span) */}
      <Header currentHijriDate={getHijriDate()} />

      <main className="max-w-6xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          
          [span_2](start_span){/* المحتوى الرئيسي: قائمة السور[span_2](end_span) */}
          ...
          [span_3](start_span){/* الجانب الأيسر: تم حذف الورد اليومي وآخر ما قرأت[span_3](end_span) */}
