  ...
  return (
    <div className="min-h-screen transition-colors duration-300">
      <div className="relative">
        ...
        {/* زر أصغر وموضع محسّن لعدم تغطية العنوان */}
        <button 
          onClick={() => setDarkMode(!darkMode)}
          className="absolute top-4 left-4 p-2 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 text-white hover:bg-white/20 transition-all z-50 text-xs flex items-center gap-1"
        >
          {darkMode ? '☀️' : '🌙'}
        </button>
      </div>
